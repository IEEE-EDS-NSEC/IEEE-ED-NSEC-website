...
(function (global, factory) {
    ...
    (global.uk3UIkitSortable = factory(global.uk3UIkit.util));
    ...
    var Component = {
        ...
        methods: {
            ...
            start: function(e) {
                ...
                uikitUtil.attr(this.drag, 'uk3-no-boot', '');
    ...
    /* global uk3UIkit, 'sortable' */

    if (typeof window !== 'undefined' && window.uk3UIkit) {
        window.uk3UIkit.component('sortable', Component);
    }
