...
(function (global, factory) {
    ...
    (global.uk3UIkitNotification = factory(global.uk3UIkit.util));
    ...
    var Component = {
        ...
        created: function() {
            ...
            if (!containers[this.pos]) {
                containers[this.pos] = uikitUtil.append(this.$container, ("<div class=\"uk3-notification uk3-notification-" + (this.pos) + "\"></div>"));
            }
    ...
    /* global uk3UIkit, 'notification' */

    if (typeof window !== 'undefined' && window.uk3UIkit) {
        window.uk3UIkit.component('notification', Component);
    }
