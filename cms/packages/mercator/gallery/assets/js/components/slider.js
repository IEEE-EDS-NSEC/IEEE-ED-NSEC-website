...
(function (global, factory) {
    ...
    (global.uk3UIkitSlider = factory(global.uk3UIkit.util));
        ...
        update: {
            ...
            write: function() {
                ...
                uikitUtil.$$(("[" + (this.attrItem) + "],[data-" + (this.attrItem) + "]"), this.$el).forEach(function (el) {
                    ...
                    this$1.maxIndex && uikitUtil.toggleClass(el, 'uk3-hidden', uikitUtil.isNumeric(index) && (this$1.sets && !uikitUtil.includes(this$1.sets, uikitUtil.toFloat(index)) || index > this$1.maxIndex));
                });
    ...
    /* global uk3UIkit, 'slider' */

    if (typeof window !== 'undefined' && window.uk3UIkit) {
        window.uk3UIkit.component('slider', Component);
    }
