...
(function (global, factory) {
    ...
    (global.uk3UIkitLightbox = factory(global.uk3UIkit.util));
            ...
            toggleElement: function(targets, show, animate) {
                ...
                return new uikitUtil.Promise(function (resolve) {
                    ...
                    if (!this$1.queued || !uikitUtil.isUndefined(animate) || !uikitUtil.isUndefined(show) || !this$1.hasAnimation || targets.length < 2) {
                        ...
                        var el = toggled[0];
                        var inProgress = uikitUtil.Animation.inProgress(el) && uikitUtil.hasClass(el, 'uk3-animation-leave')
            ...
            _toggleElement: function(el, show, animate) {
                ...
                show = uikitUtil.isBoolean(show)
                    ...
                    : uikitUtil.Animation.inProgress(el)
                        ? uikitUtil.hasClass(el, 'uk3-animation-leave')
    ...
    var SliderNav = {
        ...
        update: {
            ...
            write: function() {
                ...
                uikitUtil.toggleClass(uikitUtil.$$(this.navItemSelector, this.$el).concat(this.nav), 'uk3-hidden', !this.maxIndex);
        ...
        methods: {
            ...
            updateNav: function() {
                ...
                this.navItems.forEach(function (el) {
                    ...
                    uikitUtil.toggleClass(el, 'uk3-invisible', this$1.finite && (cmd === 'previous' && i === 0 || cmd === 'next' && i >= this$1.maxIndex));
                });
    ...
    var LightboxPanel = {
        ...
        created: function() {
            ...
            this.caption = uikitUtil.$('.uk3-lightbox-caption', this.$el);
...

            {
                ...
                handler: function(_, item) {
                    ...
                    if (type === 'image' || source.match(/\.(jp(e)?g|png|gif|svg)($|\?)/i)) {
                        ...
                        var video = uikitUtil.$(("<video controls playsinline" + (item.poster ? (" poster=\"" + (item.poster) + "\"") : '') + " uk3-video=\"" + (this.videoAutoplay) + "\"></video>"));
        ...
        methods: {
            ...
            showControls: function() {
                ...
                uikitUtil.addClass(this.$el, 'uk3-active', 'uk3-transition-active');

            },

            hideControls: function() {
                uikitUtil.removeClass(this.$el, 'uk3-active', 'uk3-transition-active');
            }
    ...
    function getIframe(src, width, height, autoplay) {
        return ("<iframe src=\"" + src + "\" width=\"" + width + "\" height=\"" + height + "\" style=\"max-width: 100%; box-sizing: border-box;\" frameborder=\"0\" allowfullscreen uk3-video=\"autoplay: " + autoplay + "\" uk3-responsive></iframe>");
    }
    ...
    function install(uk3UIkit, Lightbox) {
    ...
    /* global uk3UIkit, 'lightbox' */

    if (typeof window !== 'undefined' && window.uk3UIkit) {
        window.uk3UIkit.component('lightbox', Component);
    }
