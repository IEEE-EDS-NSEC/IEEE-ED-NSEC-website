...
(function (global, factory) {
    ...
    function getCssVar(name) {
        ...
        if (!isIE) {
            return getStyles(docEl).getPropertyValue(("--uk3-" + name));
        }

        if (!(name in vars)) {

            /* usage in css: .uk3-name:before { content:"xyz" } */

            var element = append(docEl, document.createElement('div'));

            addClass(element, ("uk3-" + name));
    ...
    function transition(element, props, duration, timing) {
        ...
        return Promise.all(toNodes(element).map(function (element) { return new Promise(function (resolve, reject) {
                ...
                once(element, 'transitionend transitioncanceled', function (ref) {
                    ...
                    clearTimeout(timer);
                    removeClass(element, 'uk3-transition');
                    css(element, {
                        'transition-property': '',
                        'transition-duration': '',
                ...
                addClass(element, 'uk3-transition');
                css(element, assign({
    ...
    var Transition = {
        ...
        inProgress: function(element) {
            return hasClass(element, 'uk3-transition');
        }

    };

    var animationPrefix = 'uk3-animation-';
    var clsCancelAnimation = 'uk3-cancel-animation';
    ...
    function animate(element, animation, duration, origin, out) {
        ...
        return Promise.all(toNodes(element).map(function (element) { return new Promise(function (resolve, reject) {
                ...
                if (startsWith(animation, animationPrefix)) {
                    ...
                    if (origin) {
                        cls += " uk3-transform-origin-" + origin;
                    }
    ...
    */
    ...
    function componentAPI (uk3UIkit) {

        var DATA = uk3UIkit.data;

        var components = {};

        uk3UIkit.component = function (name, options) {

            if (!options) {

                if (isPlainObject(components[name])) {
                    components[name] = uk3UIkit.extend(components[name]);
                }
            ...
            uk3UIkit[name] = function (element, data$$1) {
                var i = arguments.length, argsArray = Array(i);
                while ( i-- ) argsArray[i] = arguments[i];


                var component = uk3UIkit.component(name);
                ...
                function init(element) {
                    ...
                    var instance = uk3UIkit.getComponent(element, name);
            ...
            if (opt.install) {
                opt.install(uk3UIkit, opt, name);
            }

            if (uk3UIkit._initialized && !opt.functional) {
                var id = hyphenate(name);
                fastdom.read(function () { return uk3UIkit[name](("[uk3-" + id + "],[data-uk3-" + id + "]")); });
            }

            return components[name] = isPlainObject(options) ? opt : options;
        };

        uk3UIkit.getComponents = function (element) { return element && element[DATA] || {}; };
        uk3UIkit.getComponent = function (element, name) { return uk3UIkit.getComponents(element)[name]; };

        uk3UIkit.connect = function (node) {
        ...
        uk3UIkit.disconnect = function (node) {
            for (var name in node[DATA]) {
    ...
    function getComponentName(attribute) {
        return startsWith(attribute, 'uk3-') || startsWith(attribute, 'data-uk3-')
            ? camelize(attribute.replace('data-uk3-', '').replace('uk3-', ''))
            : false;
    }

    function boot (uk3UIkit) {

        var connect = uk3UIkit.connect;
        var disconnect = uk3UIkit.disconnect;
        ...
        function applyAttribute(ref) {
            ...
            if (!name || !(name in uk3UIkit)) {
                return;
            }

            if (hasAttr(target, attributeName)) {
                uk3UIkit[name](target);
                return true;
            }

            var component = uk3UIkit.getComponent(target, name);
        ...
        function apply$$1(node, fn) {
            ...
            if (node.nodeType !== 1 || hasAttr(node, 'uk3-no-boot')) {
                return;
            }
    ...
    function globalAPI (uk3UIkit) {

        var DATA = uk3UIkit.data;

        uk3UIkit.use = function (plugin) {
        ...
        uk3UIkit.mixin = function (mixin, component) {
            component = (isString(component) ? uk3UIkit.component(component) : component) || this;
            component.options = mergeOptions(component.options, mixin);
        };

        uk3UIkit.extend = function (options) {

            options = options || {};

            var Super = this;
            var Sub = function uk3UIkitComponent (options) {
                this._init(options);
            };
        ...
        uk3UIkit.update = function (element, e) {
        ...
        var container;
        Object.defineProperty(uk3UIkit, 'container', {
    ...
    function hooksAPI (uk3UIkit) {

        uk3UIkit.prototype._callHook = function (hook) {
            var this$1 = this;
        ...
        uk3UIkit.prototype._callConnected = function () {
        ...
        uk3UIkit.prototype._callDisconnected = function () {
        ...
        uk3UIkit.prototype._callUpdate = function (e) {
            var this$1 = this;
    ...
    function stateAPI (uk3UIkit) {

        var uid = 0;

        uk3UIkit.prototype._init = function (options) {
        ...
        uk3UIkit.prototype._initData = function () {
            var this$1 = this;
        ...
        uk3UIkit.prototype._initMethods = function () {
            var this$1 = this;
        ...
        uk3UIkit.prototype._initComputeds = function () {
            var this$1 = this;
        ...
        uk3UIkit.prototype._resetComputeds = function () {
            this._computeds = {};
        };

        uk3UIkit.prototype._initProps = function (props) {
            var this$1 = this;
        ...
        uk3UIkit.prototype._initEvents = function () {
            var this$1 = this;
        ...
        uk3UIkit.prototype._unbindEvents = function () {
            this._events.forEach(function (unbind) { return unbind(); });
            this._events = [];
        };

        uk3UIkit.prototype._initObserver = function () {
            var this$1 = this;
    ...
    function instanceAPI (uk3UIkit) {

        var DATA = uk3UIkit.data;

        uk3UIkit.prototype.$mount = function (el) {
        ...
        uk3UIkit.prototype.$emit = function (e) {
            this._callUpdate(e);
        };

        uk3UIkit.prototype.$reset = function () {
            this._callDisconnected();
            this._callConnected();
        };

        uk3UIkit.prototype.$destroy = function (removeEl) {
        ...
        uk3UIkit.prototype.$create = function (component, element, data$$1) {
            return uk3UIkit[component](element, data$$1);
        };

        uk3UIkit.prototype.$update = uk3UIkit.update;
        uk3UIkit.prototype.$getComponent = uk3UIkit.getComponent;

        var names = {};
        Object.defineProperties(uk3UIkit.prototype, {

            $container: Object.getOwnPropertyDescriptor(uk3UIkit, 'container'),
            ...
            $name: {
                ...
                get: function() {
                    ...
                    if (!names[name]) {
                        names[name] = uk3UIkit.prefix + hyphenate(name);
                    }
    ...
    var uk3UIkit = function (options) {
        this._init(options);
    };

    uk3UIkit.util = util;
    uk3UIkit.data = '__uikit__';
    uk3UIkit.prefix = 'uk3-';
    uk3UIkit.options = {};
    ...
    hooksAPI(uk3UIkit);
    stateAPI(uk3UIkit);
    componentAPI(uk3UIkit);
    instanceAPI(uk3UIkit);
            ...
            toggleElement: function(targets, show, animate$$1) {
                ...
                return new Promise(function (resolve) {
                    ...
                    if (!this$1.queued || !isUndefined(animate$$1) || !isUndefined(show) || !this$1.hasAnimation || targets.length < 2) {
                        ...
                        var el = toggled[0];
                        var inProgress = Animation.inProgress(el) && hasClass(el, 'uk3-animation-leave')
            ...
            _toggleElement: function(el, show, animate$$1) {
                ...
                show = isBoolean(show)
                    ...
                    : Animation.inProgress(el)
                        ? hasClass(el, 'uk3-animation-leave')
    ...
    var Accordion = {
        ...
        data: {
            ...
            multiple: false,
            clsOpen: 'uk3-open',
            toggle: '> .uk3-accordion-title',
            content: '> .uk3-accordion-content',
            transition: 'ease'
        },
    ...
    function Core (uk3UIkit) {
        ...
        ready(function () {
            ...
            on(window, 'load resize', function (e) { return uk3UIkit.update(null, e); });
            on(window, 'scroll', function (e) {
                var target = e.target;
                e.dir = scroll <= window.pageYOffset ? 'down' : 'up';
                e.pageYOffset = scroll = window.pageYOffset;
                uk3UIkit.update(target.nodeType !== 1 ? document.body : target, e);
            }, {passive: true, capture: true});
            on(document, 'loadedmetadata load', function (ref) {
                var target = ref.target;

                return uk3UIkit.update(target, 'load');
            }, true);

            on(document, 'animationstart', function (ref) {
                var target = ref.target;

                if ((css(target, 'animationName') || '').match(/^uk3-.*(left|right)/)) {
            ...
            Object.defineProperty(uk3UIkit, 'hoverSelector', {
            ...
            uk3UIkit.hoverSelector = '.uk3-animation-toggle, .uk3-transition-toggle, [uk3-hover]';
    ...
    var Drop = {
        ...
        computed: {
            ...
            clsDrop: function(ref) {
                ...
                return clsDrop || ("uk3-" + (this.$options.name));
            },
...

            {
                ...
                handler: function(ref) {
                    ...
                    if (current === this.input) {
                        toggleClass(
                            this.state,
                            ("uk3-" + (includes(type, 'focus') ? 'focus' : 'hover')),
    ...
    var Margin = {
        ...
        data: {
            margin: 'uk3-margin-small-top',
            firstColumn: 'uk3-first-column'
        },
    ...
    var Grid = {
        ...
        data: {
            margin: 'uk3-grid-margin',
            clsStack: 'uk3-grid-stack',
            masonry: false,
            parallax: 0
        },
        ...
        connected: function() {
            this.masonry && addClass(this.$el, 'uk3-flex-top uk3-flex-wrap-top');
        },
    ...
    var Slidenav = {
        ...
        computed: {
            ...
            icon: function(ref, $el) {
                ...
                return hasClass($el, 'uk3-slidenav-large')
                    ? (icon + "-large")
                    : icon;
            }
    ...
    var Search = {
        ...
        computed: {
            ...
            icon: function(ref, $el) {
                ...
                return hasClass($el, 'uk3-search-icon') && parents($el, '.uk3-search-large').length
                    ? 'search-large'
                    : parents($el, '.uk3-search-navbar').length
                        ? 'search-navbar'
                        : icon;
            }
    ...
    var Close = {
        ...
        computed: {
            ...
            icon: function() {
                return ("close-" + (hasClass(this.$el, 'uk3-close-large') ? 'large' : 'icon'));
            }
    ...
    function install(uk3UIkit) {
        uk3UIkit.icon.add = function (name, svg) {
            var obj;
            ...
            if (uk3UIkit._initialized) {
                apply(document.body, function (el) { return each(uk3UIkit.getComponents(el), function (cmp) { return cmp.$options.isIcon && cmp.icon in added && cmp.$reset(); }
                    ); }
                );
            }
        };
    ...
    var Leader = {
        ...
        data: {
            fill: '',
            clsWrapper: 'uk3-leader-fill',
            clsHide: 'uk3-leader-hide',
            attrFill: 'data-fill'
        },
    ...
    var Modal$1 = {
        ...
        data: {
            clsPage: 'uk3-modal-page',
            selPanel: '.uk3-modal-dialog',
            selClose: '.uk3-modal-close, .uk3-modal-close-default, .uk3-modal-close-outside, .uk3-modal-close-full'
        },
        ...
        events: [

            {
                ...
                handler: function() {
                    ...
                    if (hasClass(this.panel, 'uk3-margin-auto-vertical')) {
                        addClass(this.$el, 'uk3-flex');
                    } else {
    ...
    function install$1 (uk3UIkit) {

        uk3UIkit.modal.dialog = function (content, options) {

            var dialog = uk3UIkit.modal((" <div class=\"uk3-modal\"> <div class=\"uk3-modal-dialog\">" + content + "</div> </div> "), options);
        ...
        uk3UIkit.modal.alert = function (message, options) {

            options = assign({bgClose: false, escClose: false, labels: uk3UIkit.modal.labels}, options);

            return new Promise(
                function (resolve) { return on(uk3UIkit.modal.dialog((" <div class=\"uk3-modal-body\">" + (isString(message) ? message : html(message)) + "</div> <div class=\"uk3-modal-footer uk3-text-right\"> <button class=\"uk3-button uk3-button-primary uk3-modal-close\" autofocus>" + (options.labels.ok) + "</button> </div> "), options).$el, 'hide', resolve); }
            );
        };

        uk3UIkit.modal.confirm = function (message, options) {

            options = assign({bgClose: false, escClose: true, labels: uk3UIkit.modal.labels}, options);

            return new Promise(function (resolve, reject) {

                var confirm = uk3UIkit.modal.dialog((" <form> <div class=\"uk3-modal-body\">" + (isString(message) ? message : html(message)) + "</div> <div class=\"uk3-modal-footer uk3-text-right\"> <button class=\"uk3-button uk3-button-default uk3-modal-close\" type=\"button\">" + (options.labels.cancel) + "</button> <button class=\"uk3-button uk3-button-primary\" autofocus>" + (options.labels.ok) + "</button> </div> </form> "), options);
        ...
        uk3UIkit.modal.prompt = function (message, value, options) {

            options = assign({bgClose: false, escClose: true, labels: uk3UIkit.modal.labels}, options);

            return new Promise(function (resolve) {

                var prompt = uk3UIkit.modal.dialog((" <form class=\"uk3-form-stacked\"> <div class=\"uk3-modal-body\"> <label>" + (isString(message) ? message : html(message)) + "</label> <input class=\"uk3-input\" autofocus> </div> <div class=\"uk3-modal-footer uk3-text-right\"> <button class=\"uk3-button uk3-button-default uk3-modal-close\" type=\"button\">" + (options.labels.cancel) + "</button> <button class=\"uk3-button uk3-button-primary\">" + (options.labels.ok) + "</button> </div> </form> "), options),
    ...
    var Navbar = {
        ...
        data: {
            dropdown: '.uk3-navbar-nav > li',
            align: !isRtl ? 'left' : 'right',
            clsDrop: 'uk3-navbar-dropdown',
            mode: undefined,
            offset: undefined,
            delayShow: undefined,
            delayHide: undefined,
            ...
            duration: 200,
            forceHeight: true,
            selMinHeight: '.uk3-navbar-nav > li > a, .uk3-navbar-item, .uk3-navbar-toggle'
        },
        ...
        beforeConnect: function() {
            ...
            this.dropbar = dropbar && (query(dropbar, this.$el) || $('+ .uk3-navbar-dropbar', this.$el) || $('<div></div>'));

            if (this.dropbar) {

                addClass(this.dropbar, 'uk3-navbar-dropbar');

                if (this.dropbarMode === 'slide') {
                    addClass(this.dropbar, 'uk3-navbar-dropbar-slide');
                }
            }
    ...
    var Offcanvas = {
        ...
        data: {
            ...
            flip: false,
            overlay: false,
            clsPage: 'uk3-offcanvas-page',
            clsContainer: 'uk3-offcanvas-container',
            selPanel: '.uk3-offcanvas-bar',
            clsFlip: 'uk3-offcanvas-flip',
            clsContainerAnimation: 'uk3-offcanvas-container-animation',
            clsSidebarAnimation: 'uk3-offcanvas-bar-animation',
            clsMode: 'uk3-offcanvas',
            clsOverlay: 'uk3-offcanvas-overlay',
            selClose: '.uk3-offcanvas-close'
        },
    ...
    var OverflowAuto = {
        ...
        data: {
            selContainer: '.uk3-modal',
            selContent: '.uk3-modal-dialog',
        },
    ...
    var Responsive = {
        ...
        connected: function() {
            addClass(this.$el, 'uk3-responsive-width');
        },
    ...
    var Scrollspy = {
        ...
        data: function () { return ({
            ...
            repeat: false,
            delay: 0,
            inViewClass: 'uk3-scrollspy-inview'
        }); },
                ...
                read: function(els) {
                    ...
                    this.elements.forEach(function (el, i) {
                        ...
                        if (!elData || elData.el !== el) {
                            var cls = data(el, 'uk3-scrollspy-class');
    ...
    var Sticky = {
        ...
        data: {
            ...
            offset: 0,
            animation: '',
            clsActive: 'uk3-active',
            clsInactive: '',
            clsFixed: 'uk3-sticky-fixed',
            clsBelow: 'uk3-sticky-below',
            selTarget: '',
            widthElement: false,
            showOnUp: false,
            targetOffset: false
        ...
        connected: function() {
            this.placeholder = $('+ .uk3-sticky-placeholder', this.$el) || $('<div class="uk3-sticky-placeholder"></div>');
        },
    ...
    var Switcher = {
        ...
        data: {
            connect: '~.uk3-switcher',
            toggle: '> *',
            active: 0,
            swiping: true,
            cls: 'uk3-active',
            clsContainer: 'uk3-switcher',
            attrItem: 'uk3-switcher-item',
            queued: true
        },
        ...
        events: [

            {
                ...
                delegate: function() {
                    return ((this.toggle) + ":not(.uk3-disabled)");
                },
        ...
        methods: {
            ...
            show: function(item) {
                ...
                for (var i = 0; i < length; i++, next = (next + dir + length) % length) {
                    if (!matches(this$1.toggles[next], '.uk3-disabled, [disabled]')) {
    ...
    var Tab = {
        ...
        data: {
            media: 960,
            attrItem: 'uk3-tab-item'
        },

        connected: function() {

            var cls = hasClass(this.$el, 'uk3-tab-left')
                ? 'uk3-tab-left'
                : hasClass(this.$el, 'uk3-tab-right')
                    ? 'uk3-tab-right'
                    : false;
    ...
    function core (uk3UIkit) {
        ...
        // core components
        uk3UIkit.component('accordion', Accordion);
        uk3UIkit.component('alert', Alert);
        uk3UIkit.component('cover', Cover);
        uk3UIkit.component('drop', Drop);
        uk3UIkit.component('dropdown', Dropdown);
        uk3UIkit.component('formCustom', FormCustom);
        uk3UIkit.component('gif', Gif);
        uk3UIkit.component('grid', Grid);
        uk3UIkit.component('heightMatch', HeightMatch);
        uk3UIkit.component('heightViewport', HeightViewport);
        uk3UIkit.component('icon', Icon);
        uk3UIkit.component('img', Img);
        uk3UIkit.component('leader', Leader);
        uk3UIkit.component('margin', Margin);
        uk3UIkit.component('modal', Modal$1);
        uk3UIkit.component('nav', Nav);
        uk3UIkit.component('navbar', Navbar);
        uk3UIkit.component('offcanvas', Offcanvas);
        uk3UIkit.component('overflowAuto', OverflowAuto);
        uk3UIkit.component('responsive', Responsive);
        uk3UIkit.component('scroll', Scroll);
        uk3UIkit.component('scrollspy', Scrollspy);
        uk3UIkit.component('scrollspyNav', ScrollspyNav);
        uk3UIkit.component('sticky', Sticky);
        uk3UIkit.component('svg', SVG);
        uk3UIkit.component('switcher', Switcher);
        uk3UIkit.component('tab', Tab);
        uk3UIkit.component('toggle', Toggle);
        uk3UIkit.component('video', Video);

        // Icon components
        uk3UIkit.component('close', Close);
        uk3UIkit.component('marker', IconComponent);
        uk3UIkit.component('navbarToggleIcon', IconComponent);
        uk3UIkit.component('overlayIcon', IconComponent);
        uk3UIkit.component('paginationNext', IconComponent);
        uk3UIkit.component('paginationPrevious', IconComponent);
        uk3UIkit.component('searchIcon', Search);
        uk3UIkit.component('slidenavNext', Slidenav);
        uk3UIkit.component('slidenavPrevious', Slidenav);
        uk3UIkit.component('spinner', Spinner);
        uk3UIkit.component('totop', IconComponent);
    ...
    var targetClass = 'uk3-animation-target';
    ...
    var SliderNav = {
        ...
        update: {
            ...
            write: function() {
                ...
                toggleClass($$(this.navItemSelector, this.$el).concat(this.nav), 'uk3-hidden', !this.maxIndex);
        ...
        methods: {
            ...
            updateNav: function() {
                ...
                this.navItems.forEach(function (el) {
                    ...
                    toggleClass(el, 'uk3-invisible', this$1.finite && (cmd === 'previous' && i === 0 || cmd === 'next' && i >= this$1.maxIndex));
                });
    ...
    var Slideshow = {
        ...
        data: {
            animation: 'slide',
            clsActivated: 'uk3-transition-active',
    ...
    var LightboxPanel = {
        ...
        created: function() {
            ...
            this.caption = $('.uk3-lightbox-caption', this.$el);
        ...
        events: [
...

            {
                ...
                handler: function(_, item) {
                    ...
                    this.setItem(item, '<span uk3-spinner></span>');
                    ...
                    if (type === 'image' || source.match(/\.(jp(e)?g|png|gif|svg)($|\?)/i)) {
                        ...
                        var video = $(("<video controls playsinline" + (item.poster ? (" poster=\"" + (item.poster) + "\"") : '') + " uk3-video=\"" + (this.videoAutoplay) + "\"></video>"));
                        ...
                        this.setItem(item, ("<iframe class=\"uk3-lightbox-iframe\" src=\"" + source + "\" frameborder=\"0\" allowfullscreen></iframe>"));
        ...
        methods: {
            ...
            setError: function(item) {
                this.setItem(item, '<span uk3-icon="icon: bolt; ratio: 2"></span>');
            },
            ...
            showControls: function() {
                ...
                addClass(this.$el, 'uk3-active', 'uk3-transition-active');

            },

            hideControls: function() {
                removeClass(this.$el, 'uk3-active', 'uk3-transition-active');
            }
    ...
    function getIframe(src, width$$1, height$$1, autoplay) {
        return ("<iframe src=\"" + src + "\" width=\"" + width$$1 + "\" height=\"" + height$$1 + "\" style=\"max-width: 100%; box-sizing: border-box;\" frameborder=\"0\" allowfullscreen uk3-video=\"autoplay: " + autoplay + "\" uk3-responsive></iframe>");
    }
    ...
    function install$2(uk3UIkit, Lightbox) {

        if (!uk3UIkit.lightboxPanel) {
            uk3UIkit.component('lightboxPanel', LightboxPanel);
        }

        assign(
            Lightbox.props,
            uk3UIkit.component('lightboxPanel').options.props
        );
    ...
    var Notification = {
        ...
        data: {
            ...
            group: null,
            pos: 'top-center',
            clsClose: 'uk3-notification-close',
            clsMsg: 'uk3-notification-message'
        },
        ...
        created: function() {
            ...
            if (!containers[this.pos]) {
                containers[this.pos] = append(this.$container, ("<div class=\"uk3-notification uk3-notification-" + (this.pos) + "\"></div>"));
            }

            var container = css(containers[this.pos], 'display', 'block');

            this.$mount(append(container,
                ("<div class=\"" + (this.clsMsg) + (this.status ? (" " + (this.clsMsg) + "-" + (this.status)) : '') + "\"> <a href=\"#\" class=\"" + (this.clsClose) + "\" data-uk3-close></a> <div>" + (this.message) + "</div> </div>")
            ));
    ...
    function install$3(uk3UIkit) {
        uk3UIkit.notification.closeAll = function (group, immediate) {
            apply(document.body, function (el) {
                var notification = uk3UIkit.getComponent(el, 'notification');
    ...
    var Slider$1 = {
        ...
        data: {
            center: false,
            sets: false,
            attrItem: 'uk3-slider-item',
            selList: '.uk3-slider-items',
            selNav: '.uk3-slider-nav',
            clsContainer: 'uk3-slider-container',
        ...
        update: {
            ...
            write: function() {
                ...
                $$(("[" + (this.attrItem) + "],[data-" + (this.attrItem) + "]"), this.$el).forEach(function (el) {
                    ...
                    this$1.maxIndex && toggleClass(el, 'uk3-hidden', isNumeric(index$$1) && (this$1.sets && !includes(this$1.sets, toFloat(index$$1)) || index$$1 > this$1.maxIndex));
                });
    ...
    var Slideshow$1 = {
        ...
        data: {
            ...
            minHeight: false,
            maxHeight: false,
            selList: '.uk3-slideshow-items',
            attrItem: 'uk3-slideshow-item',
            selNav: '.uk3-slideshow-nav',
    ...
    var Sortable = {
        ...
        data: {
            group: false,
            threshold: 5,
            clsItem: 'uk3-sortable-item',
            clsPlaceholder: 'uk3-sortable-placeholder',
            clsDrag: 'uk3-sortable-drag',
            clsDragState: 'uk3-drag',
            clsBase: 'uk3-sortable',
            clsNoDrag: 'uk3-sortable-nodrag',
            clsEmpty: 'uk3-sortable-empty',
            clsCustom: '',
            handle: false
        },
    ...
    var Tooltip = {
        ...
        data: {
            ...
            title: '',
            delay: 0,
            animation: ['uk3-animation-scale-up'],
            duration: 100,
            cls: 'uk3-active',
            clsPos: 'uk3-tooltip'
        },
    ...
    uk3UIkit.component('countdown', Countdown);
    uk3UIkit.component('filter', Filter);
    uk3UIkit.component('lightbox', Lightbox);
    uk3UIkit.component('lightboxPanel', LightboxPanel);
    uk3UIkit.component('notification', Notification);
    uk3UIkit.component('parallax', Parallax$1);
    uk3UIkit.component('slider', Slider$1);
    uk3UIkit.component('sliderParallax', SliderParallax);
    uk3UIkit.component('slideshow', Slideshow$1);
    uk3UIkit.component('slideshowParallax', SliderParallax);
    uk3UIkit.component('sortable', Sortable);
    uk3UIkit.component('tooltip', Tooltip);
    uk3UIkit.component('upload', Upload);
